...
# Librerias para mandar el correo electronico
...
# Librerias para las expresiones regulares
import re

# Lireria para el manejo de la interfaz grafica
...
class ReporteMed(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.ASSETS_PATH = self.OUTPUT_PATH / Path(r"assets/reporte_med")
    ...
    def crear_elementos_formulario(self):
        ...
        if(lista_presion_sistolica[2] != "N/A" and lista_presion_diastolica[2] != "N/A"):
            self.lista_presion = ["", "", str(lista_presion_diastolica[2]) + '/' + str(lista_presion_sistolica[2])]
        else:
            self.lista_presion = ["", "", "N/A"]
        
        # Proceso de unificacion de la lista de la presion arterial
        ...
        # Campos calculados del reporte
        
        self.fecha_actual_str = date.today().strftime("%Y/%m/%d")
        self.edad = self.calcular_edad()
        self.nota_aclaratoria = self.crear_nota_aclaratoria()
        self.ruta_logo = self.relative_to_assets("logo1.png")
        self.ruta_pdf = str(self.relative_to_assets("Reporte_HeartBeat.pdf"))

        
        # Iniciacion de la pantalla
        self.controller.title("Reporte de mediciones")
        ...
        self.img_logo = PhotoImage(
            file=self.relative_to_assets("logo1.png"))
        ...
        self.lbl_nombre = Label(
            self,
            text=self.controller.sujeto.nombres + " " + self.controller.sujeto.apellidos,
            bd=0,
            bg="#F5F5F5",
            fg="#000716",
            font=("RobotoRoman Regular", 25 * -1)
        ...
        self.lbl_sexo = Label(
            self,
            text=self.controller.sujeto.sexo.descripcion,
            bd=0,
            bg="#F5F5F5",
            fg="#000716",
            font=("RobotoRoman Regular", 25 * -1)
        ...
        self.lbl_peso = Label(
            self,
            text=self.controller.medicion.peso_sujeto,
            bd=0,
            bg="#F5F5F5",
            fg="#000716",
            font=("RobotoRoman Regular", 25 * -1)
        ...
        self.lbl_estatura = Label(
            self,
            text=self.controller.medicion.altura_sujeto,
            bd=0,
            bg="#F5F5F5",
            fg="#000716",
            font=("RobotoRoman Regular", 25 * -1)
        ...
        self.canvas.create_text(
            ...
            247.0,
            anchor="nw",
            text= (self.controller.sujeto.tipo_documento.descripcion) + ":",
            fill="#000000",
            font=("RobotoRoman Regular", 25 * -1)
        )
        self.lbl_cod_doc = Label(
            self,
            text= self.controller.sujeto.codigo_documento,
            bd=0,
            bg="#F5F5F5",
            fg="#000716",
            font=("RobotoRoman Regular", 25 * -1)
        ...
        self.img_guardar = PhotoImage(
            file=self.relative_to_assets("btn_guardar.png"))
    ...
    # Se calcula en base a todas las condiciones medicas que posee el sujeto y todas las mediciones que esa condicion puede afectar
        mensaje = ""
        if self.controller.sujeto.condiciones_medicas != []: #si el sujeto tiene alguna condicion
            for x in self.controller.sujeto.condiciones_medicas: #para cada condicion que el sujeto tenga
    ...
    def calcular_edad(self): #retorna la edad en años del sujeto
        ...
        edad = (fecha_actual_date - self.controller.sujeto.fecha_nacimiento) #le resto a la fecha actual la fecha de nacimiento
    ...
    def buscar_parametro(self, parametro_fis): #le paso el parametro que quiero revisar, retorna una lista de tres elementos, se ejecuta una vez por cada parametro
        ...
        for x in self.controller.medicion.parametros_medidos: #para cada medicion dentro de la lista de parametros medidos
    ...
    def enviar_pdf(self, correo_envio):
        ...
        ruta_pdf = self.relative_to_assets(nombre_pdf)
    ...
    def confirmar_correo(self):
        ...
        while correo_envio == None:
            if(messagebox.askyesno("Confirmar envio","¿Desea recibir el reporte a su correo?")== True):
                ...
                initialvalue= self.controller.sujeto.correo)
        ...
        self.controller.sujeto = None
        self.controller.medicion = None
